...
export const TILE_INDEX = {
  ...
  ch: { tile: "wall", solid: true },
  po: { tile: "wall", solid: true },
  qc: { tile: "wall", solid: true },
  tm: { tile: "wall", solid: true },
  tp: { tile: "dungeonFloorAlt", solid: false },
  dn: { tile: "dungeonFloor", solid: false },
  pg: { tile: "dungeonFloorAlt", solid: false },
